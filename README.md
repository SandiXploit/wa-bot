...
<details>
 ...
 [Saweria](https://saweria.co/donate/SandiFake)
 
 [Trakteer](https://trakteer.id/SanPloit)
 
 [Paypal.me](https://paypal.me/SandiHeker)
...
```bash
> git clone https://github.com/Sandi-Fake/BotWhatsApp
> cd BotWhatsApp
```
